...
foreach ($results as $url) {
  $content .= '<div class="r"><a href="'.htmlentities($url['url']).'" class="link">Report '.$url->_id.'</a><a href="http://localhost/roadsec-web-1/web/hide.php?id='.$url->_id.'" class="link">Hide</a></div>';
}
